...
class LUC_AVLTree {
    ...
    public boolean isBST()           { return isBST(rootNode); }
     ...
     *
     *  inorderTraversal() is a private method that uses recursion. It prints the
     *  [sub]tree using an inorder traversal method. For each node printed, it 
     *  prints the pair "[Value: X, Height: Y]" where X represents the value of 
     *  the node, and Y represents the node's height in the tree. Think of a 
     *  node's height as the number of edges to the deepest leaf of that node.
     *
